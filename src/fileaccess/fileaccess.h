...
void *fa_open_resolver(const char *url, char *errbuf, size_t errsize,
...
enum {
  ...
  FA_LOAD_TAG_NO_FALLBACK,
  FA_LOAD_TAG_CACHE_EVICT,
};
...
#define FA_LOAD_NO_FALLBACK()           FA_LOAD_TAG_NO_FALLBACK
#define FA_LOAD_CACHE_EVICT()           FA_LOAD_TAG_CACHE_EVICT
