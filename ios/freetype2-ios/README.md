...
Movian's copy of this project uses the FreeType 2.14.3 source and headers.  The
Xcode target builds an arm64 static library for the configured iOS deployment
target and includes the TrueType/OpenType, CFF, autofit, and raster modules.
